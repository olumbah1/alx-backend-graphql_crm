# Generated by Django 5.2.7 on 2025-10-16 14:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message="Phone number must be in format: '+999999999' or '999-999-9999'", regex='^\\+?1?\\d{9,15}$|^\\d{3}-\\d{3}-\\d{4}$')])),
